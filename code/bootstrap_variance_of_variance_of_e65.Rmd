---
title: "Bootstrap of variance in variance of e65"
...
Truncate Mx values Nx values 
```{r}
Mx = lapply(Mx, function(x) x[65:111])
Nx = lapply(Nx, function(x) x[65:111])
```
...
# save as csv
write.csv(df, paste(path, "boot_results_e65.csv", sep = "/"), row.names = TRUE)
```
